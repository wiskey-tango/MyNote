...
//		setResult(RESULT_CANCELED);
	...
	OnClickListener mBtnClick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			TextView mTextView = (TextView) MyNoteConf.this.findViewById(R.id.EditText02);
			SharedPreferences.Editor prefs = MyNoteConf.this.getSharedPreferences(mPerfName, 0).edit();
			prefs.putString("DAT" + mAppWidgetId, mTextView.getText().toString());
			prefs.commit();
			...
			RemoteViews views = new RemoteViews(MyNoteConf.this.getPackageName(), R.layout.my_note_widget);
